use crate::utils::{
    ...
    holders_security_state::{HoldersSecurityState, IHoldersSecurityState, RecoveryError},
    holders_state::{HolderState, HolderStateError, IHoldersState},
    sponsors_state::ISponsorsState,
    tokens_security_state::{ITokensSecurityState, TokenSecurityState},
    tokens_state::{ITokensState, TokenState, TokenStateError},
};
use concordium_std::*;
...
impl From<RecoveryError> for StateError {
    fn from(e: RecoveryError) -> Self { StateError::RecoveryError(e) }
}
