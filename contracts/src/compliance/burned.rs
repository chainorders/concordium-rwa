...
///
/// This function is called when tokens are burned. It iterates over all modules in the state,
/// and calls the `burned` function on the `ComplianceContract` for each module.
///
/// # Errors
///
